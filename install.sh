...
install_XrayR() {
    ...
    file="https://github.com/liudongkai/XrayR-script/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/liudongkai/XrayR-script/master/XrayR.sh
...
echo -e "${green}开始安装 ${release} ${os_version} ${arch} ${plain}"
install_base
install_acme
install_XrayR $1
